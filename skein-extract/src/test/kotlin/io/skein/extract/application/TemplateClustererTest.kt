...
internal class TemplateClustererTest {

    private val clusterer = TemplateClusterer()

    @Test
    internal fun `groups texts that share a structural signature`() {
    ...
    @Test
    internal fun `returns one cluster when all texts share a shape`() {
        val clusters = clusterer.cluster(texts = listOf("alpha 1.00", "beta 2.00"))
